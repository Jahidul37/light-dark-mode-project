...
// local storage dark theme and light theme set korar jonno
...
// ----------------------------------------------
  ...
  return (
    <div className="navbar  bg-base-200 ">
      <div className="navbar-start">
        ...
        <a className="btn btn-ghost text-xl font-medium">Light dark Test</a>
      </div>
  ...
  <input type="checkbox" onClick={handeToggle}
